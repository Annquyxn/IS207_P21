...
export default function ChatTab({ onClose }) {
  ...
  return (
    <section 
      className="fixed bottom-[20px] right-5 w-[380px] h-[580px] flex flex-col bg-white rounded-2xl shadow-xl z-50 border border-red-100 overflow-hidden"
      style={{ 
      ...
      <div className="relative flex items-center justify-between px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-red-100 text-xs">Hỗ trợ trả lời mọi thắc mắc về sản phẩm</p>
          </div>
        </div>
        ...
        {loading && (
          <div className="flex gap-3 items-start mt-4 animate-pulse">
            ...
            <div className="bg-red-100 rounded-2xl px-4 py-3 text-base max-w-[75%]">
              ...
              <p className="mt-1 text-red-500 text-sm">Đang tìm kiếm sản phẩm phù hợp...</p>
            </div>
          </div>
        )}
