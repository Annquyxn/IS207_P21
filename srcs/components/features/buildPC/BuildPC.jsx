...
const COMPONENTS = [
  ...
  { key: 'MH', name: 'Màn hình', image: '/srcs/assets/buildPC/MH.png' },
  {
    key: 'case',
    name: 'Case máy tính',
    ...
    <main className='max-w-[1200px] mx-auto px-4 py-8'>
      ...
      <div className='bg-white p-4 rounded shadow mb-6'>
        ...
        <div className='flex flex-wrap gap-3'>
          <button
            onClick={handleReset}
            className='border border-gray-300 px-4 py-2 rounded bg-white hover:bg-gray-50 text-sm text-red-500'
          >
            <FiRefreshCcw className='inline-block mr-3 transition' />
            Chọn lại từ đầu
          </button>
          <button className='border border-gray-300 px-4 py-2 rounded bg-white hover:bg-gray-50 text-sm text-red-500'>
