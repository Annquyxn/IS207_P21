...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 font-sans">
      <h1 className="text-2xl font-bold mb-6">Chính sách bảo mật thông tin</h1>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mb-4">
            <li className="mb-1">Hỗ trợ khách hàng</li>
            <li className="mb-1">Cung cấp thông tin liên quan đến dịch vụ</li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5">
            <li className="mb-1">Công Ty TNHH Thương Mại GEARVN</li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5">
            <li className="mb-1">
              Địa chỉ: 82 Hoàng Hoa Thám, Phường 12, Quận Tân Bình, TP Hồ Chí
              Minh
            </li>
            <li className="mb-1">Điện thoại: 1800 6175</li>
            <li className="mb-1">Website: www.gearvn.com</li>
