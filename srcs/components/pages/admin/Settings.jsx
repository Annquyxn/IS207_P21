      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-gray-800">Thông báo đơn hàng mới</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-gray-800">Thông báo email</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-gray-800">Thông báo hết hàng</h3>
                      <p className="text-sm text-gray-600">Nhận thông báo khi sản phẩm hết hàng</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
            ...
            {activeTab === 'security' && (
              <div>
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Cài đặt bảo mật</h2>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Mật khẩu hiện tại
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex space-x-3">
                      <div className="w-8 h-8 rounded-full bg-red-600 border-2 border-white outline outline-2 outline-red-600 cursor-pointer"></div>
                      <div className="w-8 h-8 rounded-full bg-blue-600 border-2 border-white outline outline-1 outline-gray-200 cursor-pointer"></div>
                      <div className="w-8 h-8 rounded-full bg-green-600 border-2 border-white outline outline-1 outline-gray-200 cursor-pointer"></div>
                      <div className="w-8 h-8 rounded-full bg-purple-600 border-2 border-white outline outline-1 outline-gray-200 cursor-pointer"></div>
                      <div className="w-8 h-8 rounded-full bg-yellow-500 border-2 border-white outline outline-1 outline-gray-200 cursor-pointer"></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      Tắt hiệu ứng chuyển động nếu bạn cảm thấy khó chịu với các animation.
                    </p>
                  </div>
