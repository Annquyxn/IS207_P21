...
import VoucherBadge from "@/components/features/voucher/VoucherBadge";
...
function CompleteOrderPage() {
  ...
  return (
    <main className="max-w-[978px] mx-auto px-4 pb-12">
      ...
      <section className="w-full bg-white border border-black shadow-md rounded-xl p-8 mt-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 text-lg">
            ...
            <span className="text-[#e40000] font-bold">{orderDetails.deliveryEstimate}</span>
          </div>
      ...
      <section className="w-full bg-white border border-black shadow-md rounded-xl p-8 mt-8">
        <h2 className="text-xl md:text-2xl font-bold mb-6 text-center">Thông tin giao hàng</h2>
