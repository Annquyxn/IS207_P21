...
import { FiMenu, FiX, FiLogOut, FiBell, FiUser, FiChevronDown } from "react-icons/fi";
          ...
          <div className="flex items-center space-x-4">
                ...
                {showNotifications && (
                  ...
                  >
                    <div className="p-3 bg-gray-50 border-b border-gray-200">
                      <h3 className="font-semibold text-gray-700">Thông báo ({notifications.length})</h3>
                    </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <FiChevronDown className={`transition-transform duration-200 ${showUserMenu ? 'rotate-180' : ''}`} />
              </button>
